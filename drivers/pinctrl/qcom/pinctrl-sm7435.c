...
static const struct pinctrl_pin_desc sm7435_pins[] = {
...
static const struct pinfunction sm7435_functions[] = {
	...
	MSM_PIN_FUNCTION(dp0_hot_plug),
	MSM_PIN_FUNCTION(gcc_gp1_clk),
	MSM_PIN_FUNCTION(gcc_gp2_clk),
	MSM_PIN_FUNCTION(gcc_gp3_clk),
	MSM_PIN_FUNCTION(host2wlan_sol_mira),
	MSM_PIN_FUNCTION(host2wlan_sol_mirb),
	...
	MSM_PIN_FUNCTION(qlink1_wmss_reset),
	...
	MSM_PIN_FUNCTION(qup0_se5_l4),
	MSM_PIN_FUNCTION(qup0_se5_l5),
	MSM_PIN_FUNCTION(qup0_se5_l6),
	...
	MSM_PIN_FUNCTION(wlan2_adc_dtest0),
	MSM_PIN_FUNCTION(wlan2_adc_dtest1),
};
...
static const struct msm_pingroup sm7435_groups[] = {
	...
	[15] = PINGROUP(15, qup1_se5_l1, NA, NA, NA, ddr_pxi0_test, NA, NA, NA,
			NA),
	[16] = PINGROUP(16, qup1_se5_l2, NA, NA, NA, NA, NA, NA, NA, NA),
	...
	[21] = PINGROUP(21, qup1_se2_l3, NA, phase_flag_status16,
			tgu_ch1_trigout, NA, NA, NA, NA, NA),
	...
	[31] = PINGROUP(31, qup0_se0_l3, dp0_hot_plug, NA, gcc_gp2_clk,
			...
			atest_usb0_testdataout02, NA, NA),
	...
	[42] = PINGROUP(42, cam_mclk, host2wlan_sol_mira, prng_rosc_test2,
			qdss_gpio_tracedata3, NA, NA, NA, NA, NA),
	...
	[54] = PINGROUP(54, cci_i2c_scl2, PCIE0_CLK_REQ, gcc_gp2_clk,
			qdss_gpio_tracedata8, NA, NA, NA, NA, NA),
	...
	[57] = PINGROUP(57, NA, phase_flag_status27, qdss_gpio_tracedata14,
			atest_char_status2, NA, NA, NA, NA, NA),
	[58] = PINGROUP(58, NA, phase_flag_status28, qdss_gpio_tracedata15,
			atest_char_status3, NA, NA, NA, NA, NA),
	[59] = PINGROUP(59, coex_uart1_rx, NA, NA, NA, NA, NA, NA, NA, NA),
	[60] = PINGROUP(60, coex_uart1_tx, NA, NA, NA, NA, NA, NA, NA, NA),
	...
	[65] = PINGROUP(65, jitter_bist_ref, tmess_prng_rosc3, NA,
			ddr_pxi1_test, NA, NA, NA, NA, NA),
	[66] = PINGROUP(66, wlan2_adc_dtest1, atest_usb0_testdataout00, NA, NA,
			NA, NA, NA, NA, NA),
	[67] = PINGROUP(67, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[68] = PINGROUP(68, uim0_data, NA, NA, NA, NA, NA, NA, NA, NA),
	[69] = PINGROUP(69, uim0_clk, NA, NA, NA, NA, NA, NA, NA, NA),
	[70] = PINGROUP(70, uim0_reset, NA, NA, NA, NA, NA, NA, NA, NA),
	[71] = PINGROUP(71, uim0_present, NA, phase_flag_status24,
			atest_char_start, NA, NA, NA, NA, NA),
	[72] = PINGROUP(72, uim1_data, NA, NA, NA, NA, NA, NA, NA, NA),
	[73] = PINGROUP(73, uim1_clk, NA, NA, NA, NA, NA, NA, NA, NA),
	[74] = PINGROUP(74, uim1_reset, NA, NA, NA, NA, NA, NA, NA, NA),
	[75] = PINGROUP(75, uim1_present, NA, phase_flag_status18,
			tb_trig_sdc2, NA, NA, NA, NA, NA),
	[76] = PINGROUP(76, NA, NA, NA, audio_ref_clk, NA, NA, NA, NA, NA),
	[77] = PINGROUP(77, NA, NA, pll_clk_aux, NA, NA, NA, NA, NA, NA),
	[78] = PINGROUP(78, NA, NA, NA, pll_bist_sync, NA, NA, NA, NA, NA),
	[79] = PINGROUP(79, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[80] = PINGROUP(80, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[81] = PINGROUP(81, NA, NA, NA, phase_flag_status8, NA, NA, NA, NA, NA),
	[82] = PINGROUP(82, NA, NA, NA, phase_flag_status9, NA, NA, NA, NA, NA),
	[83] = PINGROUP(83, NA, NA, NA, phase_flag_status0, NA, NA, NA, NA, NA),
	...
	[94] = PINGROUP(94, qlink0_wmss_reset, NA, NA, NA, NA, NA, NA, NA, NA),
	[95] = PINGROUP(95, qlink1_request, NA, NA, NA, NA, NA, NA, NA, NA),
	[96] = PINGROUP(96, qlink1_enable, NA, NA, NA, NA, NA, NA, NA, NA),
	[97] = PINGROUP(97, qlink1_wmss_reset, NA, NA, NA, NA, NA, NA, NA, NA),
	[98] = PINGROUP(98, i2s0_sck, qup1_se2_l4, tsense_pwm1_out,
			tsense_pwm2_out, NA, NA, NA, NA, NA),
	[99] = PINGROUP(99, mdp_vsync_p, i2s0_ws, mdp_vsync0_out,
			mdp_vsync1_out, NA, NA, NA, NA, NA),
	[100] = PINGROUP(100, usb0_phy_ps, NA, NA, NA, NA, NA, NA, NA, NA),
	[101] = PINGROUP(101, i2s0_data0, NA, phase_flag_status20, NA, NA, NA,
			 NA, NA, NA),
	[102] = PINGROUP(102, NA, phase_flag_status31, NA, NA, NA, NA, NA, NA,
			 NA),
	[103] = PINGROUP(103, mdp_vsync_p, NA, NA, NA, NA, NA, NA, NA, NA),
	[104] = PINGROUP(104, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[105] = PINGROUP(105, usb0_hs_ac, NA, NA, NA, NA, NA, NA, NA, NA),
	[106] = PINGROUP(106, vfr_0_mirb, NA, NA, NA, NA, NA, NA, NA, NA),
	...
	[111] = PINGROUP(111, i2s0_data1, NA, NA, NA, NA, NA, NA, NA, NA),
	[112] = PINGROUP(112, host2wlan_sol_mirb, dp0_hot_plug, NA, NA, NA, NA,
			 NA, NA, NA),
	[113] = PINGROUP(113, PCIE0_CLK_REQ, NA, NA, NA, NA, NA, NA, NA, NA),
	[114] = PINGROUP(114, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[115] = PINGROUP(115, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[116] = PINGROUP(116, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[117] = PINGROUP(117, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[118] = PINGROUP(118, NA, qdss_cti_trig0, NA, NA, NA, NA, NA, NA, NA),
	[119] = PINGROUP(119, qdss_cti_trig0, NA, NA, NA, NA, NA, NA, NA, NA),
	...
	[123] = PINGROUP(123, qdss_gpio_traceclk, NA, NA, NA, NA, NA, NA, NA,
			 NA),
	[124] = PINGROUP(124, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[125] = PINGROUP(125, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[126] = PINGROUP(126, qdss_gpio_tracedata7, NA, NA, NA, NA, NA, NA, NA,
			 NA),
	[127] = PINGROUP(127, qdss_gpio_tracedata8, NA, NA, NA, NA, NA, NA, NA,
			 NA),
	[128] = PINGROUP(128, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[129] = PINGROUP(129, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[130] = PINGROUP(130, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	...
	[138] = PINGROUP(138, NA, phase_flag_status22, qdss_gpio_tracedata15,
			 NA, NA, NA, NA, NA, NA),
	[139] = PINGROUP(139, NA, NA, NA, NA, NA, NA, NA, NA, NA),
...
static const struct msm_gpio_wakeirq_map sm7435_pdc_map[] = {
...
static const struct msm_pinctrl_soc_data sm7435_tlmm = {
	.pins = sm7435_pins,
	.npins = ARRAY_SIZE(sm7435_pins),
	.functions = sm7435_functions,
	.nfunctions = ARRAY_SIZE(sm7435_functions),
	.groups = sm7435_groups,
	.ngroups = ARRAY_SIZE(sm7435_groups),
	.ngpios = 142,
	.wakeirq_map = sm7435_pdc_map,
	.nwakeirq_map = ARRAY_SIZE(sm7435_pdc_map),
};

static int sm7435_tlmm_probe(struct platform_device *pdev)
{
	return msm_pinctrl_probe(pdev, &sm7435_tlmm);
}

static const struct of_device_id sm7435_tlmm_of_match[] = {
	{ .compatible = "qcom,sm7435-tlmm", },
	{ },
};

static struct platform_driver sm7435_tlmm_driver = {
	.driver = {
		.name = "sm7435-tlmm",
		.of_match_table = sm7435_tlmm_of_match,
	},
	.probe = sm7435_tlmm_probe,
	.remove = msm_pinctrl_remove,
};

static int __init sm7435_tlmm_init(void)
{
	return platform_driver_register(&sm7435_tlmm_driver);
}
arch_initcall(sm7435_tlmm_init);

static void __exit sm7435_tlmm_exit(void)
{
	platform_driver_unregister(&sm7435_tlmm_driver);
}
module_exit(sm7435_tlmm_exit);

MODULE_DESCRIPTION("QTI SM7435 TLMM driver");
MODULE_LICENSE("GPL v2");
MODULE_DEVICE_TABLE(of, sm7435_tlmm_of_match);
