...
#include <dt-bindings/interconnect/qcom,netrani-rpmh.h>
...
static struct qcom_icc_node xm_qdss_dap = {
	...
	.link_nodes = { &qhs_ahb2phy0, &qhs_ahb2phy1,
			...
			&qhs_vsense_ctrl_cfg, &qns_a1_noc_cfg,
			&qns_a2_noc_cfg, &qns_mnoc_cfg,
			&qns_cnoc2_cnoc3, &qns_pcie_anoc_cfg,
			&qns_snoc_cfg },
};
...
static struct qcom_icc_desc netrani_aggre1_noc = {
...
static struct qcom_icc_desc netrani_aggre2_noc = {
...
static struct qcom_icc_desc netrani_clk_virt = {
...
static struct qcom_icc_desc netrani_cnoc2 = {
	.nodes = cnoc2_nodes,
...
static struct qcom_icc_desc netrani_cnoc3 = {
	.nodes = cnoc3_nodes,
...
static struct qcom_icc_desc netrani_gem_noc = {
	.nodes = gem_noc_nodes,
...
static struct qcom_icc_desc netrani_lpass_ag_noc = {
...
static struct qcom_icc_desc netrani_mc_virt = {
	.nodes = mc_virt_nodes,
...
static struct qcom_icc_desc netrani_mmss_noc = {
...
static struct qcom_icc_desc netrani_nsp_noc = {
	.nodes = nsp_noc_nodes,
...
static struct qcom_icc_desc netrani_pcie_anoc = {
...
static struct qcom_icc_desc netrani_system_noc = {
...
static const struct of_device_id qnoc_of_match[] = {
	{ .compatible = "qcom,netrani-aggre1-noc",
	  .data = &netrani_aggre1_noc},
	{ .compatible = "qcom,netrani-aggre2-noc",
	  .data = &netrani_aggre2_noc},
	{ .compatible = "qcom,netrani-clk-virt",
	  .data = &netrani_clk_virt},
	{ .compatible = "qcom,netrani-cnoc2",
	  .data = &netrani_cnoc2},
	{ .compatible = "qcom,netrani-cnoc3",
	  .data = &netrani_cnoc3},
	{ .compatible = "qcom,netrani-gem-noc",
	  .data = &netrani_gem_noc},
	{ .compatible = "qcom,netrani-lpass-ag-noc",
	  .data = &netrani_lpass_ag_noc},
	{ .compatible = "qcom,netrani-mc-virt",
	  .data = &netrani_mc_virt},
	{ .compatible = "qcom,netrani-mmss-noc",
	  .data = &netrani_mmss_noc},
	{ .compatible = "qcom,netrani-nsp-noc",
	  .data = &netrani_nsp_noc},
	{ .compatible = "qcom,netrani-pcie-anoc",
	  .data = &netrani_pcie_anoc},
	{ .compatible = "qcom,netrani-system-noc",
	  .data = &netrani_system_noc},
	{ }
};
