...
static const struct qcom_rpm_resource msm8930_pm8038_rpm_resource_table[] = {
	[QCOM_RPM_CXO_CLK] =			{ 25, 9, 5, 1 },
	[QCOM_RPM_PXO_CLK] =			{ 26, 10, 6, 1 },
	[QCOM_RPM_APPS_FABRIC_CLK] =	{ 27, 11, 8, 1 },
	[QCOM_RPM_SYS_FABRIC_CLK] =		{ 28, 12, 9, 1 },
...
static const struct qcom_rpm_data msm8930_pm8038_template = {
	.version = 3,
	.resource_table = msm8930_pm8038_rpm_resource_table,
	.n_resources = ARRAY_SIZE(msm8930_pm8038_rpm_resource_table),
	.req_ctx_off = 3,
	.req_sel_off = 11,
	.ack_ctx_off = 15,
	.ack_sel_off = 23,
...
static const struct qcom_rpm_resource msm8930_pm8917_rpm_resource_table[] = {
	[QCOM_RPM_CXO_CLK] =			{ 25, 9, 5, 1 },
	[QCOM_RPM_PXO_CLK] =			{ 26, 10, 6, 1 },
	[QCOM_RPM_APPS_FABRIC_CLK] =	{ 27, 11, 8, 1 },
	[QCOM_RPM_SYS_FABRIC_CLK] =		{ 28, 12, 9, 1 },
	...
	[QCOM_RPM_MM_FABRIC_IOCTL] =	{ 78, 29, 28, 1 },
	[QCOM_RPM_MM_FABRIC_ARB] =		{ 79, 30, 29, 11 },
	[QCOM_RPM_PM8917_SMPS1] =		{ 90, 31, 30, 2 },
	[QCOM_RPM_PM8917_SMPS2] =		{ 92, 33, 31, 2 },
	[QCOM_RPM_PM8917_SMPS3] =		{ 94, 35, 32, 2 },
	[QCOM_RPM_PM8917_SMPS4] =		{ 96, 37, 33, 2 },
	[QCOM_RPM_PM8917_SMPS5] =		{ 98, 39, 34, 2 },
	[QCOM_RPM_PM8917_SMPS6] =		{ 100, 41, 35, 2 },
	[QCOM_RPM_PM8917_SMPS7] =		{ 102, 43, 36, 2 },
	[QCOM_RPM_PM8917_SMPS8] =		{ 104, 45, 37, 2 },
	[QCOM_RPM_PM8917_LDO1] =		{ 106, 47, 38, 2 },
	...
	[QCOM_RPM_PM8917_LDO9] =		{ 122, 63, 46, 2 },
	[QCOM_RPM_PM8917_LDO10] =		{ 124, 65, 47, 2 },
	[QCOM_RPM_PM8917_LDO11] =		{ 126, 67, 48, 2 },
	[QCOM_RPM_PM8917_LDO12] =		{ 128, 69, 49, 2 },
	[QCOM_RPM_PM8917_LDO14] =		{ 130, 71, 50, 2 },
	[QCOM_RPM_PM8917_LDO15] =		{ 132, 73, 51, 2 },
	[QCOM_RPM_PM8917_LDO16] =		{ 134, 75, 52, 2 },
	[QCOM_RPM_PM8917_LDO17] =		{ 136, 77, 53, 2 },
	[QCOM_RPM_PM8917_LDO18] =		{ 138, 79, 54, 2 },
	[QCOM_RPM_PM8917_LDO21] =		{ 140, 81, 55, 2 },
	[QCOM_RPM_PM8917_LDO22] =		{ 142, 83, 56, 2 },
	[QCOM_RPM_PM8917_LDO23] =		{ 144, 85, 57, 2 },
	[QCOM_RPM_PM8917_LDO24] =		{ 146, 87, 58, 2 },
	[QCOM_RPM_PM8917_LDO25] =		{ 148, 89, 59, 2 },
	[QCOM_RPM_PM8917_LDO26] =		{ 150, 91, 60, 2 },
	[QCOM_RPM_PM8917_LDO27] =		{ 152, 93, 61, 2 },
	[QCOM_RPM_PM8917_LDO28] =		{ 154, 95, 62, 2 },
	[QCOM_RPM_PM8917_LDO29] =		{ 156, 97, 63, 2 },
	[QCOM_RPM_PM8917_LDO30] =		{ 158, 99, 64, 2 },
	[QCOM_RPM_PM8917_LDO31] =		{ 160, 101, 65, 2 },
	[QCOM_RPM_PM8917_LDO32] =		{ 162, 103, 66, 2 },
	[QCOM_RPM_PM8917_LDO33] =		{ 164, 105, 67, 2 },
	...
	[QCOM_RPM_HDMI_SWITCH] =		{ 186, 127, 83, 1 },
	[QCOM_RPM_QDSS_CLK] =			{ 187, 128, 7, 1 },
	[QCOM_RPM_VOLTAGE_CORNER] =		{ 188, 129, 87, 1 },
};

static const struct qcom_rpm_data msm8930_pm8917_template = {
	.version = 3,
	.resource_table = msm8930_pm8917_rpm_resource_table,
	.n_resources = ARRAY_SIZE(msm8930_pm8917_rpm_resource_table),
	.req_ctx_off = 3,
	.req_sel_off = 11,
	.ack_ctx_off = 15,
	.ack_sel_off = 23,
...
static const struct of_device_id qcom_rpm_of_match[] = {
	...
	{ .compatible = "qcom,rpm-msm8930-pm8038", .data = &msm8930_pm8038_template },
	{ .compatible = "qcom,rpm-msm8930-pm8917", .data = &msm8930_pm8917_template },
