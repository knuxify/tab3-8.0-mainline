...
#include <dt-bindings/clock/qcom,netrani-dispcc.h>
...
static struct clk_regmap *disp_cc_netrani_clocks[] = {
...
static const struct qcom_reset_map disp_cc_netrani_resets[] = {
	[DISP_CC_MDSS_CORE_BCR] = { 0x8000 },
	[DISP_CC_MDSS_CORE_INT2_BCR] = { 0xa000 },
	[DISP_CC_MDSS_RSCC_BCR] = { 0xc000 },
};

static struct clk_alpha_pll *disp_cc_netrani_plls[] = {
	&disp_cc_pll0,
	&disp_cc_pll1,
};

static u32 disp_cc_netrani_critical_cbcrs[] = {
	0xe054, /* DISP_CC_XO_CLK */
};

static const struct regmap_config disp_cc_netrani_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static void disp_cc_netrani_clk_regs_configure(struct device *dev, struct regmap *regmap)
{
	/* Enable clock gating for MDP clocks */
	regmap_update_bits(regmap, DISP_CC_MISC_CMD, 0x10, 0x10);
}

static struct qcom_cc_driver_data disp_cc_netrani_driver_data = {
	.alpha_plls = disp_cc_netrani_plls,
	.num_alpha_plls = ARRAY_SIZE(disp_cc_netrani_plls),
	.clk_cbcrs = disp_cc_netrani_critical_cbcrs,
	.num_clk_cbcrs = ARRAY_SIZE(disp_cc_netrani_critical_cbcrs),
	.clk_regs_configure = disp_cc_netrani_clk_regs_configure,
};

static struct qcom_cc_desc disp_cc_netrani_desc = {
	.config = &disp_cc_netrani_regmap_config,
	.clks = disp_cc_netrani_clocks,
	.num_clks = ARRAY_SIZE(disp_cc_netrani_clocks),
	.resets = disp_cc_netrani_resets,
	.num_resets = ARRAY_SIZE(disp_cc_netrani_resets),
	.use_rpm = true,
	.driver_data = &disp_cc_netrani_driver_data,
};

static const struct of_device_id disp_cc_netrani_match_table[] = {
	{ .compatible = "qcom,netrani-dispcc" },
	{ }
};
MODULE_DEVICE_TABLE(of, disp_cc_netrani_match_table);

static int disp_cc_netrani_probe(struct platform_device *pdev)
{
	return qcom_cc_probe(pdev, &disp_cc_netrani_desc);
}

static struct platform_driver disp_cc_netrani_driver = {
	.probe = disp_cc_netrani_probe,
	.driver = {
		.name = "disp_cc-netrani",
		.of_match_table = disp_cc_netrani_match_table,
	},
};

module_platform_driver(disp_cc_netrani_driver);

MODULE_DESCRIPTION("QTI DISP_CC Netrani Driver");
