...
#include <dt-bindings/clock/qcom,sm7435-dispcc.h>
...
static struct clk_regmap *disp_cc_sm7435_clocks[] = {
...
static const struct qcom_reset_map disp_cc_sm7435_resets[] = {
	[DISP_CC_MDSS_CORE_BCR] = { 0x8000 },
	[DISP_CC_MDSS_CORE_INT2_BCR] = { 0xa000 },
	[DISP_CC_MDSS_RSCC_BCR] = { 0xc000 },
};

static const struct regmap_config disp_cc_sm7435_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static struct qcom_cc_desc disp_cc_sm7435_desc = {
	.config = &disp_cc_sm7435_regmap_config,
	.clks = disp_cc_sm7435_clocks,
	.num_clks = ARRAY_SIZE(disp_cc_sm7435_clocks),
	.resets = disp_cc_sm7435_resets,
	.num_resets = ARRAY_SIZE(disp_cc_sm7435_resets),
};

static const struct of_device_id disp_cc_sm7435_match_table[] = {
	{ .compatible = "qcom,sm7435-dispcc" },
	{ }
};
MODULE_DEVICE_TABLE(of, disp_cc_sm7435_match_table);

static int disp_cc_sm7435_probe(struct platform_device *pdev)
{
	...
	regmap = qcom_cc_map(pdev, &disp_cc_sm7435_desc);
	if (IS_ERR(regmap)) {
		ret = PTR_ERR(regmap);
		goto err_put_rpm;
	}
	...
	ret = qcom_cc_really_probe(&pdev->dev, &disp_cc_sm7435_desc, regmap);
	if (ret)
		goto err_put_rpm;
...
static struct platform_driver disp_cc_sm7435_driver = {
	.probe = disp_cc_sm7435_probe,
	.driver = {
		.name = "disp_cc-sm7435",
		.of_match_table = disp_cc_sm7435_match_table,
	},
};

module_platform_driver(disp_cc_sm7435_driver);

MODULE_DESCRIPTION("QTI DISPCC SM7435 / SM8475 Driver");
MODULE_LICENSE("GPL");
