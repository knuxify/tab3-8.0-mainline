...
/* SM7435 RPMH powerdomains */
static struct rpmhpd *sm7435_rpmhpds[] = {
	[RPMHPD_CX] = &cx,
	[RPMHPD_CX_AO] = &cx_ao,
	[RPMHPD_EBI] = &ebi,
	[RPMHPD_GFX] = &gfx,
...
static const struct rpmhpd_desc sm7435_desc = {
	.rpmhpds = sm7435_rpmhpds,
	.num_pds = ARRAY_SIZE(sm7435_rpmhpds),
};
...
static const struct of_device_id rpmhpd_match_table[] = {
	...
	{ .compatible = "qcom,sm7435-rpmhpd", .data = &sm7435_desc },
